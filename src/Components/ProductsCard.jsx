  ...
  return (
    <div className='bg-[#1b2316] ' id='plants'>
       <div id='plants-section'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center gap-x-2  md:gap-x-4  md:gap-20 gap-2 gap-y-40 justify-between mt-40 ml-[47px]' id='buy' >
        {data.map((item,id)=>{
